...
BUCKET_BASE="connattrib/mouseretina"
...
EXPERIMENTS = [
    ...
    ('retina.0.ld.0.0.x', 'fixed_20_100', 'anneal_slow_400'), 
    ('retina.0.ld.0.0.xyz','fixed_20_100', 'anneal_slow_400'), 
    ('retina.0.ld.0.0.yz' , 'fixed_20_100', 'anneal_slow_400'), 
    ('retina.1.ld.0.0.x', 'fixed_20_100', 'anneal_slow_400'), 
    ('retina.1.ld.0.0.xyz','fixed_20_100', 'anneal_slow_400'), 
    ('retina.1.ld.0.0.yz' , 'fixed_20_100', 'anneal_slow_400'), 
